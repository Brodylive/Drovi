...
<div id="overlay" style="display:none;" onclick="$('#overlay, #popupfortop').hide();"></div>
	...
	<div id="menu_0" class="on content">
		...
		<div class="inscription">	
			...
			<a href="#" id="_2" class="ghost" onclick="multiClass(this.id);" alt="mot de passe oubli�">Mot de passe oubli�?</a>
	...
	<div id="menu_1" class="off content">
		...
		<div class="inscription">	
			...
			<a href="#" id="_0" class="ghost" onclick="multiClass(this.id);height_inscript();" alt="se connecter">D�ja inscrit? Connectes-toi!</a>
	
		</div>
	</div>
	
	<div id="menu_2" class="off content">
		<h2 class="inscription">Mot de passe oubli�</h2>
		<div class="inscription">	
			...
			<a href="#" id="_0" class="ghost" onclick="multiClass(this.id);height_inscript();" alt="se connecter">Mot de passe retrouv�? Connectes-toi!</a>
